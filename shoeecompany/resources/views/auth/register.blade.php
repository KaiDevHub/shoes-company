            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="stateArea" class="col-md-4 col-form-label text-md-right">{{ __('State Area') }}</label>

                            <div class="col-md-6">
                                <input id="stateArea" type="text" class="form-control @error('stateArea') is-invalid @enderror" name="stateArea" value="{{ old('stateArea') }}" required autocomplete="stateArea" autofocus>
